...
__declspec(dllexport) void _spAtlasPage_createTexture (spAtlasPage* self, const char* path);
__declspec(dllexport) void _spAtlasPage_disposeTexture (spAtlasPage* self);
__declspec(dllexport) char* _spUtil_readFile (const char* path, int* length);
...
__declspec(dllexport) void* _malloc (size_t size, const char* file, int line);
__declspec(dllexport) void* _calloc (size_t num, size_t size, const char* file, int line);
__declspec(dllexport) void _free (void* ptr);

__declspec(dllexport) void _setMalloc (void* (*_malloc) (size_t size));
__declspec(dllexport) void _setDebugMalloc (void* (*_malloc) (size_t size, const char* file, int line));
__declspec(dllexport) void _setFree (void (*_free) (void* ptr));

__declspec(dllexport) char* _readFile (const char* path, int* length);
...
__declspec(dllexport) spTrackEntry* _spTrackEntry_create (spAnimationState* self);
__declspec(dllexport) void _spTrackEntry_dispose (spTrackEntry* self);

/**/

__declspec(dllexport) void _spAttachmentLoader_init (spAttachmentLoader* self, /**/
		void (*dispose) (spAttachmentLoader* self), /**/
		spAttachment* (*newAttachment) (spAttachmentLoader* self, spSkin* skin, spAttachmentType type, const char* name,
				const char* path));
__declspec(dllexport) void _spAttachmentLoader_deinit (spAttachmentLoader* self);
__declspec(dllexport) void _spAttachmentLoader_setError (spAttachmentLoader* self, const char* error1, const char* error2);
__declspec(dllexport) void _spAttachmentLoader_setUnknownTypeError (spAttachmentLoader* self, spAttachmentType type);
...
__declspec(dllexport) void _spAttachment_init (spAttachment* self, const char* name, spAttachmentType type, /**/
												void (*dispose) (spAttachment* self));
__declspec(dllexport) void _spAttachment_deinit (spAttachment* self);
...
__declspec(dllexport) void _spTimeline_init (spTimeline* self, spTimelineType type, /**/
		void (*dispose) (spTimeline* self), /**/
		void (*apply) (const spTimeline* self, spSkeleton* skeleton, float lastTime, float time, spEvent** firedEvents,
				int* eventsCount, float alpha));
__declspec(dllexport) void _spTimeline_deinit (spTimeline* self);
...
__declspec(dllexport) void _spCurveTimeline_init (spCurveTimeline* self, spTimelineType type, int framesCount, /**/
		void (*dispose) (spTimeline* self), /**/
		void (*apply) (const spTimeline* self, spSkeleton* skeleton, float lastTime, float time, spEvent** firedEvents,
				int* eventsCount, float alpha));
__declspec(dllexport) void _spCurveTimeline_deinit (spCurveTimeline* self);
