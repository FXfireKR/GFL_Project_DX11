...
{
private:
	unordered_map<string, TextBase*> mText;
	unordered_map<string, TextBase*>::iterator iterText;
...
public:
	...
	void ChangeText(string _key, const string _text, ...);
	...
	void SettingColor(string key, D3DXCOLOR c);
