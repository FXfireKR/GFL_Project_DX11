...
void nAnOne::LoadTray_SoundList()
{
	...
	LOAD->Add_LoadTray(keys.SOUND_ATTACK, "Characters/9a91/9A91_ATTACK_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
	LOAD->Add_LoadTray(keys.SOUND_BREAK, "Characters/9a91/9A91_BREAK_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
	LOAD->Add_LoadTray(keys.SOUND_DEFENSE, "Characters/9a91/9A91_DEFENSE_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
	LOAD->Add_LoadTray(keys.SOUND_DIALOGUE1, "Characters/9a91/9A91_DIALOGUE1_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
	LOAD->Add_LoadTray(keys.SOUND_DIALOGUE2, "Characters/9a91/9A91_DIALOGUE2_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
	LOAD->Add_LoadTray(keys.SOUND_DIALOGUE3, "Characters/9a91/9A91_DIALOGUE3_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
	LOAD->Add_LoadTray(keys.SOUND_FORMATION, "Characters/9a91/9A91_FORMATION_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
	LOAD->Add_LoadTray(keys.SOUND_GOATTACK, "Characters/9a91/9A91_GOATTACK_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
	LOAD->Add_LoadTray(keys.SOUND_MEET, "Characters/9a91/9A91_MEET_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
	LOAD->Add_LoadTray(keys.SOUND_SKILL1, "Characters/9a91/9A91_SKILL1_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
	LOAD->Add_LoadTray(keys.SOUND_SKILL2, "Characters/9a91/9A91_SKILL2_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
	LOAD->Add_LoadTray(keys.SOUND_SKILL3, "Characters/9a91/9A91_SKILL3_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
	LOAD->Add_LoadTray(keys.SOUND_TITLECALL, "Characters/9a91/9A91_TITLECALL_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
	LOAD->Add_LoadTray(keys.SOUND_WIN, "Characters/9a91/9A91_WIN_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
