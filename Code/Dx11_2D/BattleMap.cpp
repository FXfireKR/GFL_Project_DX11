...
void BattleMap::AtlasSetting(MapAtlas* atlas)
{
	...
	atlas->vecVertex.push_back(PTVertex(VEC3(-0.5f, -0.5f, 0), VEC2(atlas->uv_min.x, atlas->uv_max.y)));	//	0
	atlas->vecVertex.push_back(PTVertex(VEC3(-0.5f, 0.5f, 0), VEC2(atlas->uv_min.x, atlas->uv_min.y)));	//	1
	atlas->vecVertex.push_back(PTVertex(VEC3(0.5f, 0.5f, 0), VEC2(atlas->uv_max.x, atlas->uv_min.y)));	//	2
										
	atlas->vecVertex.push_back(PTVertex(VEC3(-0.5f, -0.5f, 0), VEC2(atlas->uv_min.x, atlas->uv_max.y)));	//	0
	atlas->vecVertex.push_back(PTVertex(VEC3(0.5f, 0.5f, 0), VEC2(atlas->uv_max.x, atlas->uv_min.y)));	//	2
	atlas->vecVertex.push_back(PTVertex(VEC3(0.5f, -0.5f, 0), VEC2(atlas->uv_max.x, atlas->uv_max.y)));	//	3
