...
void Ntw20::LoadTray_SoundList()
{
	...
	LOAD->Add_LoadTray(keys.SOUND_ATTACK, "Characters/ntw20mod/NTW20_ATTACK_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
	LOAD->Add_LoadTray(keys.SOUND_BREAK, "Characters/ntw20mod/NTW20_BREAK_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
	LOAD->Add_LoadTray(keys.SOUND_DEFENSE, "Characters/ntw20mod/NTW20_DEFENSE_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
	LOAD->Add_LoadTray(keys.SOUND_DIALOGUE1, "Characters/ntw20mod/NTW20_DIALOGUE1_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
	LOAD->Add_LoadTray(keys.SOUND_DIALOGUE2, "Characters/ntw20mod/NTW20_DIALOGUE2_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
	LOAD->Add_LoadTray(keys.SOUND_DIALOGUE3, "Characters/ntw20mod/NTW20_DIALOGUE3_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
	LOAD->Add_LoadTray(keys.SOUND_FORMATION, "Characters/ntw20mod/NTW20_FORMATION_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
	LOAD->Add_LoadTray(keys.SOUND_GOATTACK, "Characters/ntw20mod/NTW20_GOATTACK_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
	LOAD->Add_LoadTray(keys.SOUND_MEET, "Characters/ntw20mod/NTW20_MEET_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
	LOAD->Add_LoadTray(keys.SOUND_SKILL1, "Characters/ntw20mod/NTW20_SKILL1_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
	LOAD->Add_LoadTray(keys.SOUND_SKILL2, "Characters/ntw20mod/NTW20_SKILL2_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
	LOAD->Add_LoadTray(keys.SOUND_SKILL3, "Characters/ntw20mod/NTW20_SKILL3_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
	LOAD->Add_LoadTray(keys.SOUND_TITLECALL, "Characters/ntw20mod/NTW20_TITLECALL_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
	LOAD->Add_LoadTray(keys.SOUND_WIN, "Characters/ntw20mod/NTW20_WIN_JP.acb", LOADRESOURCE_TYPE::RESOURCE_SOUND);
